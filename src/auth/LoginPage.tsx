...
export function LoginPage() {
  ...
  return <main className="login-shell"><form className="login-card" onSubmit={submit}>
    <div className="login-logo">MINHHIEU<small>Dashboard · AnlanhFarm</small></div><h1>Đăng nhập Dashboard</h1><p>{adminMode ? 'Khu vực dành cho quản trị viên.' : 'Nhập mật khẩu khách hàng để xem báo cáo.'}</p>
